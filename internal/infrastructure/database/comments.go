...
func (r *CommentsRepository) Create(comment models.Comment) (*models.Comment, error) {
	query := `
...
func (r *CommentsRepository) Find(id string) (*models.Comment, error) {
	query := `
...
func (r *CommentsRepository) FindList(id string) ([]models.Comment, error) {
	query := `
		SELECT id, reply_to_id, replied_ids, user_id, content, created_at, empathy, insight, mediocre
		FROM comments
...
// Update 特定のコメントを更新
func (r *CommentsRepository) Update(comment models.Comment) (*models.Comment, error) {
	query := `
		UPDATE comments
